...
public class TransactionProcessing {
    ...
    public boolean readPaymentObject(String path) {
         try{
             File f = new File(path); // O(1)
             Scanner sc = new Scanner(f); // O(1)
             ArrayList<Payment> paymentObjects = new ArrayList<Payment>(); // O(1)
                        ...
                        BankAccount bank = (BankAccount)payment2;
                            ...
                            for(Payment payment3 : paymentObjects){
                                if(payment3 instanceof EWallet){
                                    ...
                                    if(Ew.getSoDienThoai() == IDcardOfMember.getSoDienThoai()){
                                        hasBoth = true;
                                        break;
                                    }
                                }
            ...
            switch(data[0]){
                ...
                for(Payment payment : paymentObjects){
                    if(payment instanceof EWallet) {
                        ...
                        int phoneNumber = Ew.getSoDienThoai();   
                            ...
                            if(phoneNumber == Integer.parseInt(data[4])){
                                for(Payment payment1 : paymentObjects){
                                    ...
                                    if(payment1 instanceof ConvenientCard){
                                        ...
                                        if(ID.getSoDienThoai() == phoneNumber && ID.getSoDienThoai() == Integer.parseInt(data[4])){
                                            
                                            String genderOfCostumer = ID.getGioiTinh();
                                            
                                            int ageOfCostumer = Year.now().getValue() - Integer.parseInt(ID.getNgayThangNamSinh().substring(6, 10));
